...
export declare const IExtensionManagementService: import("../../instantiation/common/instantiation").ServiceIdentifier<IExtensionManagementService>;
export declare const IExtensionGalleryService: import("../../instantiation/common/instantiation").ServiceIdentifier<IExtensionGalleryService>;
...
export declare const INSTALL_ERROR_NOT_SUPPORTED = "notsupported";
...
export declare const IGlobalExtensionEnablementService: import("../../instantiation/common/instantiation").ServiceIdentifier<IGlobalExtensionEnablementService>;
...
export declare type IExecutableBasedExtensionTip = {
    extensionId: string;
} & Omit<Omit<IExeBasedExtensionTip, 'recommendations'>, 'important'>;
export declare type IWorkspaceTips = {
    readonly remoteSet: string[];
    readonly recommendations: string[];
};
export declare const IExtensionTipsService: import("../../instantiation/common/instantiation").ServiceIdentifier<IExtensionTipsService>;
