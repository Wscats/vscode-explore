import { ExtensionKind } from '../../extensions/common/extensions';
import { IStringDictionary } from '../../../base/common/collections';
export declare const IProductService: import("../../instantiation/common/instantiation").ServiceIdentifier<IProductService>;
...
export declare type ConfigurationSyncStore = {
    url: string;
...
export interface IProductConfiguration {
    ...
    readonly extensionImportantTips?: {
        [id: string]: {
            name: string;
            pattern: string;
